...
<div class="pageTitle clearfix"><!--<a href="products.asp"><img src="images/more.jpg"></a>--><div class="title">联系我们</div></div>
<article>
	<%=page_content %><br>
     <!--百度地图容器-->
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(121.444001,31.199612);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"云吉他培训中心",content:"地址：上海市徐汇区虹桥路18弄28楼D座（实业公寓）<br/>上海联系人：许老师<br/>",point:"121.443471|31.199612",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
		 ];
    //创建marker
    function addMarker(){
